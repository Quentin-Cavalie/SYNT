...
void SparkEmitter::setOrigin(glm::vec3 origin)
{
    this->Origin = origin;
}

void SparkEmitter::EmitParticle( Particle& particle )
{
...
void SparkEmitter::RenderSphere( glm::vec4 color, float fRadius )
{
    float X, Y, Z, inc, azi;
