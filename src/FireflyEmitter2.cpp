...
FireflyEmitter2::FireflyEmitter2()
: MinimumRadius(0)
, MaximumRadius(0.6)
, MinInclination(0)
, MaxInclination(360)
...
bool FireflyEmitter2::Active()
{
    return isActive;
}

void FireflyEmitter2::setOrigin(glm::vec3 origin)
{
    this->Origin = origin;
    this->Position = origin;
}

void FireflyEmitter2::setVelocity(glm::vec3 velocity)
{
	this->Velocity = velocity;
}

float FireflyEmitter2::getMaxLife()
{
	return 0;
}

float FireflyEmitter2::getAge()
{
	return Age;
}

void FireflyEmitter2::Update(glm::vec3 rotCenter, float fDeltaTime)
{
    Angle += 7 % 360;
...
void FireflyEmitter2::EmitParticle( Particle& particle )
{
...
void FireflyEmitter2::RenderSphere( glm::vec4 color, float fRadius )
{
    float X, Y, Z, inc, azi;
...
void FireflyEmitter2::DebugRender()
{
