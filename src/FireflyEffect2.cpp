...
FireflyEffect2::FireflyEffect2(unsigned int numParticles /* = 0 */)
: m_pCamera( NULL )
...
FireflyEffect2::~FireflyEffect2()
{
}

void FireflyEffect2::SetCamera( Camera* pCamera )
{
    m_pCamera = pCamera;
}

void FireflyEffect2::SetParticleEmitter( ParticleEmitter* pEmitter )
{
    m_pParticleEmitter = pEmitter;
}

void FireflyEffect2::SetColorInterplator( const ColorInterpolator& colors )
{
    m_ColorInterpolator = colors;
}

bool FireflyEffect2::LoadTexture( const std::string& fileName )
{
    // if ( m_TextureID != 0 )
...
void FireflyEffect2::RandomizeParticle( Particle& particle )
{
...
void FireflyEffect2::RandomizeParticles()
{
...
void FireflyEffect2::EmitParticle( Particle& particle )
{
    assert( m_pParticleEmitter != NULL );
    m_pParticleEmitter->EmitParticle( particle );
}

void FireflyEffect2::EmitParticles()
{
...
void FireflyEffect2::BuildVertexBuffer()
{
...
void FireflyEffect2::Update(float fDeltaTime)
{
...
void FireflyEffect2::Resize( unsigned int numParticles )
{
